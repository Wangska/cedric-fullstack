...
<head>
    ...
    <title>Clinic Management System - Deployment Test</title>
    ...
    <div class="max-w-4xl mx-auto p-8">
        <div class="bg-white rounded-lg shadow-lg p-8">
            <div class="text-center mb-8">
                ...
                <p class="text-xl text-gray-600">Deployment Status Check</p>
            </div>
            ...
            <div class="mt-8 bg-gray-50 border border-gray-200 rounded-lg p-6">
                ...
                <div class="grid md:grid-cols-2 gap-4 text-sm">
                    <div>
                        <strong>DB_HOST:</strong> <?php echo htmlspecialchars($host); ?><br>
                        <strong>DB_DATABASE:</strong> <?php echo htmlspecialchars($dbname); ?><br>
                        <strong>DB_USERNAME:</strong> <?php echo htmlspecialchars($username); ?><br>
                    </div>
                    <div>
                        <strong>DB_PORT:</strong> <?php echo htmlspecialchars($port); ?><br>
            ...
            <div class="mt-8 text-center">
                <a href="index.php" class="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors inline-block mr-4">
                    Go to Main Application
                </a>
                <a href="admin/dashboard.php" class="bg-green-600 text-white px-6 py-3 rounded-lg hover:bg-green-700 transition-colors inline-block">
                    Admin Dashboard
                </a>
            </div>
