...
try {
    ...
    $count_queries = [
        'pending' => "SELECT COUNT(*) FROM appointments WHERE student_id = ? AND status = 'pending'",
        ...
        'rescheduled' => "SELECT COUNT(*) FROM appointments WHERE student_id = ? AND status = 'rescheduled'"
    ];
