        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            <div class="flex h-[600px]">
                ...
                <div class="w-1/3 border-r border-gray-200 bg-gray-50">
                    <div class="p-6 border-b border-gray-200">
                        ...
                        <p class="text-sm text-gray-500"><?php echo count($messages); ?> messages</p>
                    </div>
            ...
            <?php else: ?>
                    ...
                    <?php foreach ($messages as $index => $msg): ?>
                                <div class="message-item <?php echo $index < count($messages) - 1 ? 'border-b border-gray-200' : 'mb-4'; ?> hover:bg-white transition-colors cursor-pointer" onclick="showMessageModal(<?php echo $index; ?>)">
                                    <div class="p-4">
                        ...
                        <div class="p-6 border-b border-gray-200" id="messageHeader">
                            <div class="flex items-start justify-between">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <button class="p-2 text-gray-400 hover:text-red-500 transition-colors" onclick="deleteMessage()">
