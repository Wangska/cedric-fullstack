    ...
    try {
      ...
      if ($user) {
        ...
        if ($user['status'] !== 'Active') {
          ...
          // Log the login event
          try {
            $logDb = new PDO($dsn, $username, $password);
        ...
        if ($faculty) {
          ...
          $importDb = new PDO($dsn, $username, $password);
          ...
          <div>
             <form class="space-y-4 md:space-y-6">
               <div>
                 ...
                 <input type="text" class="modern-input w-full mobile-tiny-contact-form" placeholder="Your name">
               </div>
               <div>
                 <label class="block text-white font-medium mb-2 mobile-tiny-contact-form">Email</label>
                 <input type="email" class="modern-input w-full mobile-tiny-contact-form" placeholder="your@email.com">
               </div>
               <div>
                 <label class="block text-white font-medium mb-2 mobile-tiny-contact-form">Message</label>
                 <textarea rows="3" class="modern-input w-full resize-none mobile-tiny-contact-form" placeholder="Your message"></textarea>
               </div>
               <button type="submit" class="gradient-button text-white px-6 py-3 md:px-8 md:py-4 rounded-xl font-semibold hover:shadow-lg transition-all duration-300 w-full flex items-center justify-center mobile-tiny-contact-button">
                 Send Message
                 <i class="ri-arrow-right-line ml-2"></i>
               </button>
             </form>
